...
We reuse the **JSONObject** named websiteHeader as above for instance,
    ...
    new Thread(() -> {
        try {
            ...
            org.magiclen.mson.Mson.toString(fos, websiteHeader, (object, enter, depth) -> {
                // Do something
            });
...
For example,
    ...
    final org.magiclen.mson.JSONType json = org.magiclen.mson.Mson.toJSON(array);
    System.out.println(org.magiclen.mson.Mson.format(json, true));
...
For example,
    ...
    obj.b = 888;
    obj.c = 3.14;
    final org.magiclen.mson.JSONType json = org.magiclen.mson.Mson.toJSON(obj);
    System.out.println(org.magiclen.mson.Mson.toString(json, true));
...
If you are sure whether the object is array or not, you can assign **OBJECT** type or **ARRAY** type defined in *org.magiclen.mson.JSONType.Type* explicitly to improve the performance. The code can be modified like this:
    ...
    final org.magiclen.json.JSONObject json = (org.magiclen.json.JSONObject) org.magiclen.mson.Mson.toJSON(obj, org.magiclen.mson.JSONType.Type.OBJECT);
...
We reuse **MyClass** in previous paragraph and use **toObject** for example,
    ...
    final org.magiclen.json.JSONObject json = (org.magiclen.json.JSONObject) org.magiclen.mson.Mson.fromString("{\"a\":\"hello\",\"b\":888,\"c\":3.14}", JSONType.Type.OBJECT);
    final Object obj = org.magiclen.mson.Mson.toObject(json, String.class, MyClass.class);
...
Use **toArray** for example,
    ...
    final org.magiclen.json.JSONArray json = (org.magiclen.json.JSONArray) org.magiclen.mson.Mson.fromString("[\"hello\",888,3.14,{\"a\":\"hello\",\"b\":888,\"c\":3.14}]", JSONType.Type.ARRAY);
...
For example,
    ...
    final org.magiclen.json.JSONObject json = (org.magiclen.json.JSONObject) org.magiclen.mson.Mson.fromString("{\"a\":\"hello\",\"b\":888,\"c\":3.14}", JSONType.Type.OBJECT);
    System.out.println(org.magiclen.mson.Mson.toXML(json));
...
For example,
    ...
    System.out.println(org.magiclen.mson.Mson.fromXML("<p>hello</p><p>888</p><p>3.14</p><a href=\"#\">hello</a><b>888</b><c>3.14</c>"));
...
equals to
    ...
    org.magiclen.mson.Mson.toString(jsonType, true);
...
equals to
    ...
    org.magiclen.mson.Mson.toXML(jsonType);
...
equals to
    ...
    org.magiclen.mson.Mson.toObject(jsonObject, type);
...
equals to
    ...
    org.magiclen.mson.Mson.toArray(jsonObject, type);
